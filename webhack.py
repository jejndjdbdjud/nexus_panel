...
def intro():
   ...
   # os.system('xdg-open https://t.me/usnexushacker')
    ...
    print blue+"[\033[1;31m24\033[1;94m] \033[1;35m>>\033[1;32m Join Our Telegram"
    print blue+"[\033[1;31m25\033[1;94m] \033[1;35m>>\033[1;32m About"
    print blue+"[\033[1;31m26\033[1;94m] \033[1;35m>>\033[1;32m Open DDoS V2"
    print blue+"[\033[1;31m27\033[1;94m] \033[1;35m>>\033[1;32m Open DDoS V1"
    print blue+"[\033[1;31m28\033[1;94m] \033[1;35m>>\033[1;32m Contact With Me"
    print blue+"[\033[1;31m29\033[1;94m] \033[1;35m>>\033[1;32m Join Our Facebook Page"
    print blue+"[\033[1;31m30\033[1;94m] \033[1;35m>>\033[1;32m Join Our Facebook Group"
   ...
   # choise condition
    if user_choise == "1":
       os.system('cd files && python3 xc.py')
         ...
         os.system('cd files && cd US-DDOS-V2 && python3 USNEXUS.py')
         
    elif user_choise == "27":
         os.system('cd files && cd US-NEXUS-DDOS- && python3 usnexus.py')
         
    elif user_choise == "28":
         os.system('xdg-open "https://t.me/usnexusfuckinge4or"')
         
    elif user_choise == "29":
         os.system('xdg-open "https://www.facebook.com/profile.php?id=100095333029334"') 
         
    elif user_choise == "30":
         os.system('xdg-open "https://www.facebook.com/groups/123126950826932"') 
